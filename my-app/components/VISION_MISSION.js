...
const VisionMission = () => {
  return (
    <div className="bg-white text-black px-6 md:px-16 py-12 max-w-5xl mx-auto">
      <h1 className="text-4xl font-bold mb-10">VISION E MISSION</h1>

      {/* LA NASCITA DELL’IPAB */}
      <h2 className="text-lg font-bold mb-2 uppercase">LA NASCITA DELL’IPAB</h2>
      <p className="mb-4">
      ...
      {/* COS’È OGGI L’IPAB */}
      <h2 className="text-lg font-bold mb-2 uppercase">COS’È OGGI L’IPAB</h2>
      <p>
